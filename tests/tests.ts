...
// //Utilities
//
// function createFighter(name):RWFighterState {
//     let myFighter;
...
//         myFighter = getMock(RWFighterState);
//         let randomId = -1;
//         do {
...
//
//     it("should create a user named Aelith", function () { //1
...
//     }, DEFAULT_TIMEOUT_UNIT_TEST);
//
//     it("should create a user with all the stats adding up to the requirement", async function () { //2
...
//     }, DEFAULT_TIMEOUT_UNIT_TEST);
//
//     it("should check if a joining user exists", async function (done) { //4
...
//         }
//         else {
//             done.fail(new Error("Did not successfully check if the user was already ready"));
//         }
//     }, DEFAULT_TIMEOUT_UNIT_TEST);
// });
//
